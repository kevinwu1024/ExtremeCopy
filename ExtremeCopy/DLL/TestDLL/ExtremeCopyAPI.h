...
extern "C"
{
	...
	// Return value:
	//			If invoke success it will reutrn count of files and folders in buffer, otherwise buffer will be cleared and return 0
	//
...
#ifdef _UNICODE
#define		ExtremeCopy_SetLicenseKey			ExtremeCopy_SetLicenseKeyW
...
#else
#define		ExtremeCopy_SetLicenseKey			ExtremeCopy_SetLicenseKeyA
