...
#define EXTREMECOPY_BUFFER_SIZE_32MB				32
#define EXTREMECOPY_BUFFER_SIZE_16MB				16
#define EXTREMECOPY_BUFFER_SIZE_8MB					8
#define EXTREMECOPY_BUFFER_SIZE_4MB					4
#define EXTREMECOPY_BUFFER_SIZE_2MB					2
