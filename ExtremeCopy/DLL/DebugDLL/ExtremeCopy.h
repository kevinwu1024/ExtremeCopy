...
//void __stdcall ExtremeCopy_SetNotEvaluateA(const char* lpstrSN) ;
	...
	//			If invoke successful it will reutrn true, otherwise false
	//
	bool __stdcall ExtremeCopy_StartA(int RunType,bool bSyncOrAsyn,lpfnCopyRoutineA_t lpfnCopyRoutineA=NULL,void* pRoutineParam=NULL) ;
	bool __stdcall ExtremeCopy_StartW(int RunType,bool bSyncOrAsyn,lpfnCopyRoutineW_t lpfnCopyRoutineW=NULL,void* pRoutineParam=NULL) ;
